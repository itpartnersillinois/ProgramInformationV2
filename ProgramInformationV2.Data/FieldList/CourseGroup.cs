    ...
    public class CourseGroup : BaseGroup {
        ...
        public CourseGroup() {
            ...
            FieldItems = [
                ...
                new() { Title = "Summary Link (URL)", CategoryType = CategoryType.Course, FieldType = FieldType.Link, InitialDescription = "This link is where your course page information will live, it is the live page link. You will need to copy this from your CMS (such as Sitefinity)." },
                ...
                new() { Title = "Image URL", CategoryType = CategoryType.Course, FieldType = FieldType.Link, InitialDescription = "This should link to an image that you would like featured on the course finder. You must add alternative text when linking an image." },
                new() { Title = "Image Alt Text", CategoryType = CategoryType.Course, FieldType = FieldType.Link, InitialDescription = "Alternative text for the image." },

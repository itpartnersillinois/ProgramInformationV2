    ...
    public class CredentialGroup : BaseGroup {
        ...
        public CredentialGroup() {
            ...
            FieldItems = [
                ...
                new() { Title = "Apply Now / Get More Information Link (URL)", CategoryType = CategoryType.Credential, FieldType = FieldType.Lin, InitialDescription = "Link to campus credential details or to apply for credential." },
                new() { Title = "Image URL", CategoryType = CategoryType.Credential, FieldType = FieldType.Lin, InitialDescription = "This should link to an image that you would like featured on the program finder. You must add alternative text when linking an image." },

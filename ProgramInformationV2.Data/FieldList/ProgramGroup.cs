    ...
    public class ProgramGroup : BaseGroup {
        ...
        public ProgramGroup() {
            ...
            FieldItems = [
                ...
                new() { Title = "Program Image", CategoryType = CategoryType.Program, FieldType = FieldType.Link, InitialDescription = "Description: This should link to an image that you would like featured on the program finder. You must add alternative text when uploading an image." },
                ...
                new() { Title = "Detail Program Image", CategoryType = CategoryType.Program, FieldType = FieldType.Link, InitialDescription = "Description: This should link to an image that you would like featured on the program finder. You must add alternative text when uploading an image." },
                ...
                new() { Title = "Video URL", CategoryType = CategoryType.Program, FieldType = FieldType.Link, InitialDescription = "Description: This should link to a video that you would like featured on the program page. Please be sure the video has captions and/or transcripts." },

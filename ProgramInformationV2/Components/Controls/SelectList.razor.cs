        ...
        public CredentialType? Value {
            ...
            set {
                ...
                if (Layout != null)
                    Layout.SetDirty();
                _value = value;
                ValueChanged.InvokeAsync(value.HasValue ? value.Value : CredentialType.None);
            }
        }

        [Parameter]
        public EventCallback<CredentialType> ValueChanged { get; set; }
